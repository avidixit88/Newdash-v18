...
APP_VERSION = "v2.1 Lane Partner + Biology Tightening"
...
ADC_ASSET_TERMS = [
    ...
    "xmt-1660", "sgn-b7h4v", "vobramitamab duocarmazine", "azd8205", "sgn-b7h4v", "b7-h4 adc", "b7h4 adc", "cdh6 adc", "anti-b7-h4 adc", "anti-cdh6 adc"
]
...
# v2.1: registry-derived strategic signals. These are not generic combo buckets;
# they make B7-H4/CDH6 biology and trial-design signals visible even when
# no named external partner agent is listed in the registry.
STRATEGIC_SIGNAL_PATTERNS = {
    "B7-H4 target expression": [r"\bb7[-\s]?h4\b", r"\bb7h4\b", r"\bvtcn1\b", r"b7[-\s]?h4 (positive|high|expressing|expression)", r"vtcn1 (positive|high|expressing|expression)"],
    "CDH6 target expression": [r"\bcdh6\b", r"cadherin[-\s]?6", r"cdh6 (positive|high|expressing|expression)", r"cadherin[-\s]?6 (positive|high|expressing|expression)"],
    "ADC payload/linker signal": [r"\badc\b", r"antibody[-\s]?drug conjugate", r"drug conjugate", r"deruxtecan", r"dxd", r"payload", r"linker", r"mmae", r"auristatin", r"maytansinoid"],
    "Dose escalation / expansion": [r"dose escalation", r"dose[-\s]?escalation", r"dose expansion", r"dose[-\s]?expansion", r"maximum tolerated dose", r"recommended phase 2 dose", r"rp2d"],
    "Biomarker-selected population": [r"high expression", r"positive", r"expression", r"immunohistochemistry", r"ihc", r"biomarker", r"selected", r"enriched"],
    "Ovarian / gynecologic focus": [r"ovarian", r"fallopian", r"peritoneal", r"endometrial", r"gynecologic", r"gynaecologic"],
    "Breast / TNBC focus": [r"breast", r"tnbc", r"triple[-\s]?negative"],
    "Renal focus": [r"renal", r"kidney", r"rcc", r"clear cell"],
    "ApoE4 / Alzheimer biology": [r"apoe4", r"apoe", r"amyloid", r"tau", r"mild cognitive impairment", r"dementia"],
    "Bone remodeling / Siglec-15 biology": [r"siglec[-\s]?15", r"osteogenesis imperfecta", r"bone mineral density", r"fracture", r"skeletal", r"bone remodeling"],
}
